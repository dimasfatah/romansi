<?php 
 if($_SERVER['REQUEST_METHOD'] == "POST") {
 	...
 	$query="Update konsultan set nama_depan='$nama_depan',nama_belakang='$nama_belakang',jk='$jk',email='$email',tgl_lahir='$tgl_lahir' where username='$username'";
...
include("./../config.php");
$username = $_SESSION['nama_user'];
$query= mysqli_query($koneksi,"Select * from konsultan natural join user where username='$username'");
