...
<ul class="dropdown-menu">
	...
	<div class="col-xs-12">
        ...
        <div class="panel-heading">
								<span class="panel-title pull-left text-black"><i class="fa fa-fw fa-users"></i> Data Request isi saldo</span>
...
<table class="table table-stripped table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center text-nowrap">ID Request</th>
											<th class="text-center text-nowrap">Usernama</th>
											<th class="text-center text-nowrap">Rekening Bank</th>
 	...
 	<?php
    include 'config.php';
    $client = mysqli_query($koneksi, "SELECT * from request_isisaldo");
    $no=1;
    foreach ($client as $row){
        ...
        echo "<tr>
            ...
            <td>".$nominal."</td>
            <td>".$atas_nama."</td>
			<td><a href='isi.php?id_request=$idrequest'>Proses</a>
				<a href='hapus.php?id_request=$idrequest'>Hapus</a>
	...
	<div class="col-xs-12">
		<div class="panel panel-default">
        <div class="panel-heading">
								<span class="panel-title pull-left text-black"><i class="fa fa-fw fa-users"></i> Data Request ambil saldo</span>
								<div class="btn-group btn-group-sm pull-right" role="group">
									<a class="btn btn-default" href="#"><i class="fa fa-fw fa-refresh"></i> <span class="hidden-sm">refresh</span></a>									
        </div>
								<!-- QUICK SEARCH -->
...
<table class="table table-stripped table-hover table-bordered">
 	...
 	<?php
    include 'config.php';
    $client = mysqli_query($koneksi, "SELECT * from request_ambilsaldo");
    $no=1;
    foreach ($client as $row){
    	$idrequest=$row['id_request'];
    	$username=$row['username'];
        ...
        echo "<tr>
            ...
            <td>".$nominal."</td>
            <td>".$atas_nama."</td>
			<td><a href='ambil.php?id_request=$idrequest'>Proses</a>
				<a href='hapus.php?id_request=$idrequest'>Hapus</a>
