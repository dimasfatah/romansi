...
include('config.php');
$id = $_GET['username'];
$client = mysqli_query($koneksi,"select * from client natural join user where username='$id'");
	...
	<form action="update.php" method="post">
		<table >
			...
			<tr>
				<td> Tanggal Lahir </td>
				<td>:</td>
				<td><input type="date" name="tanggallahir" value="<?php echo $row['tgl_lahir'];?> "/></td>
			</tr>
			<tr>
				<td>Tanggal Pernikahan </td>
				<td>:</td>
				<td><input type="date" name="tanggalpernikahan" value="<?php echo $row['tgl_pernikahan'];?> "/></td>
			</tr>
			<tr>
				<td>Email</td>
				<td>:</td>
			...
			<tr>
				<td>Nomor HP</td>
				<td>:</td>
				<td><input type="text" name="nohp" value="<?php echo $row['no_hp'];?> "/></td>
			</tr>
			
			<tr>
				<td>Username</td>
				<td>:</td>
				<td><input type="text" name="username" readonly value="<?php echo $row['username'];?> "/></td>
			</tr>
			...
			<tr><td colspan="2"><button type="submit" value="simpan">Update Data</button>
                        <a href="dataclient.php">Kembali</a></td>
            </tr>
		</table>
	</form>
